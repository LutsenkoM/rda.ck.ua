		...
		<div id="hs-bottom-footer">
			<div class="hs-container">
				...
				<div class="hs-site-info">
					<?php printf( esc_html__( 'Created by', 'hashone' ) ); ?>
					<span class="sep"> | </span>
					<?php printf( esc_html__( '', 'hashone' ), '<a href="https://hashthemes.com/wordpress-theme/hashone/" target="_blank">GeekHUB</a>', 'GeekHUB' ); ?>
				</div><!-- #site-info -->
			</div>
		</div>
	</footer><!-- #colophon -->
